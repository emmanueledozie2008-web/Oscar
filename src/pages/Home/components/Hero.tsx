  ...
  return (
    <section className="relative h-[600px] lg:h-[700px] overflow-hidden hero bg-no-repeat bg-cover container mx-auto px-4 max-w-screen-xl flex lg:items-center">
      <div className="flex flex-col gap-8 w-full lg:w-[60%]">
        ...
        <p
          className="font-semibold text-lg sm:text-2xl z-10"
          data-aos="fade-up"
        >
          Activating Marketplace on your Pi wallet allows you to securely trade
          your Pi assets with other pioneers, using Pi Network Escrow services,
          this is only available to pioneers who have completed KYC and migrated
          all assets to the Mainnet.
        </p>
        <div className="z-10">
          <Link to={"/validate"}>
